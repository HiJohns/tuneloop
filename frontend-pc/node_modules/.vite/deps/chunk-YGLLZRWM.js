...
var useClosable = (propCloseCollection, contextCloseCollection, fallbackCloseCollection = EmptyFallbackCloseCollection) => {
  ...
  const mergedFallbackCloseCollection = import_react2.default.useMemo(() => Object.assign({
    closeIcon: import_react2.default.createElement(CloseOutlined_default, null)
  }, fallbackCloseCollection), [fallbackCloseCollection]);
  const mergedClosableConfig = import_react2.default.useMemo(() => {
  ...
  return import_react2.default.useMemo(() => {
    ...
    if (mergedCloseIcon !== null && mergedCloseIcon !== void 0) {
      ...
      mergedCloseIcon = import_react2.default.isValidElement(mergedCloseIcon) ? import_react2.default.cloneElement(mergedCloseIcon, Object.assign(Object.assign(Object.assign({}, mergedCloseIcon.props), {
        "aria-label": (_b = (_a = mergedCloseIcon.props) === null || _a === void 0 ? void 0 : _a["aria-label"]) !== null && _b !== void 0 ? _b : contextLocale.close
      }), ariaOrDataProps)) : import_react2.default.createElement("span", Object.assign({
...
var useForceUpdate = () => {
  return import_react3.default.useReducer((ori) => ori + 1, 0);
};

// node_modules/antd/es/_util/hooks/useMergeSemantic.js
var React4 = __toESM(require_react());
var import_classnames = __toESM(require_classnames());
function mergeClassNames(schema, ...classNames2) {
  const mergedSchema = schema || {};
  return classNames2.reduce((acc, cur) => {
...
function useSemanticClassNames(schema, ...classNames2) {
  return React4.useMemo(() => mergeClassNames.apply(void 0, [schema].concat(classNames2)), [classNames2, schema]);
}
...
var usePatchElement = () => {
  const [elements, setElements] = React5.useState([]);
  const patchElement = React5.useCallback((element) => {
...
var useProxyImperativeHandle = (ref, init) => {
  return (0, import_react5.useImperativeHandle)(ref, () => {
    const refObj = init();
    const {
      nativeElement
    } = refObj;
...
var useSyncState = (initialValue) => {
  const ref = React6.useRef(initialValue);
...
var zIndexContext = import_react6.default.createContext(void 0);
if (true) {
...
var useZIndex = (componentType, customZIndex) => {
  const [, token] = useToken();
  const parentZIndex = import_react7.default.useContext(zindexContext_default);
...
function useBreakpoint(refreshOnChange = true, defaultScreens = {}) {
  const screensRef = (0, import_react8.useRef)(defaultScreens);
  const [, forceUpdate] = useForceUpdate();
...
function useMergedPropByScreen(oriProp, screen) {
  const [prop, setProp] = React9.useState(typeof oriProp === "string" ? oriProp : "");
...
var Row = React9.forwardRef((props, ref) => {
  const {
  ...
  const rowContext = React9.useMemo(() => ({
    gutter: [gutterH, gutterV],
    wrap
  }), [gutterH, gutterV, wrap]);
  return wrapCSSVar(React9.createElement(RowContext_default.Provider, {
    value: rowContext
  }, React9.createElement("div", Object.assign({}, others, {
    className: classes,
...
//# sourceMappingURL=chunk-YGLLZRWM.js.map
