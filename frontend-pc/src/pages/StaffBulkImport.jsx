...
export default function StaffBulkImport() {
  ...
  const downloadTemplate = async () => {
    try {
      ...
      const response = await fetch('/api/admin/bulk-import/template/accounts', {
      ...
      link.download = 'bulk_accounts_template.csv'
      link.click()
  ...
  const getColumns = () => [
    ...
    { title: '邮箱', dataIndex: 'key', key: 'key', width: 200 },
