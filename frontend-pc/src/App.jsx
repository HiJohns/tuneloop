...
import TechnicianProfiles from './pages/System/TechnicianProfiles'
...
function MainLayout() {
  ...
  const menuConfig = [
  {
    ...
    children: [
      ...
      { key: '/merchant/notification-settings', label: '通知设置', permission: { sysPermBits: [10] } },
    ]
  },
  {
    key: 'product',
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/repair/requests', label: '报修单列表', permission: { cusPermCodes: ['instrument:price_config', 'instrument:read'] } },
      { key: '/technician-profiles', label: '维修师档案', permission: { cusPermCodes: ['instrument:read'] } },
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/system/gift-policies', label: '乐币规则', permission: { cusPermCodes: ['rebate:manage'] } },
...
function onMenuClick(e) {
  ...
  const routeMap = {
    ...
    '/technician-profiles': { title: '维修师档案', parent: '交易管理' },
    '/system/gift-policies': { title: '乐币规则', parent: '策略配置' },
    ...
    '/merchant/notification-settings': { title: '通知设置', parent: '平台管理' },
  }
      ...
      <Layout>
        ...
        <Content className="p-6 bg-gray-100 overflow-y-auto">
          <Routes>
            ...
            <Route path="/repair/requests" element={<ProtectedRoute requiredPermission={{ cusPermCodes: ['instrument:price_config', 'instrument:read'] }}><MerchantRepairList /></ProtectedRoute>} />
            <Route path="/technician-profiles" element={<ProtectedRoute requiredPermission={{ cusPermCodes: ['instrument:read'] }}><TechnicianProfiles /></ProtectedRoute>} />
