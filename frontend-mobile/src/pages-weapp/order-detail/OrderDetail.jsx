      ...
      <ScrollView style={{ width: '100%' }}>
        ...
        <View style={{ backgroundColor: '#fff', margin: 16, borderRadius: 16, padding: 16, boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
          ...
          <View style={{ display: 'flex', justifyContent: 'space-between', paddingVertical: 6 }}>
            ...
            <Text style={{ fontSize: 13, fontWeight: '500', color: '#000' }}>{startDate} ~ {endDate}</Text>
          </View>
          <View style={{ display: 'flex', justifyContent: 'space-between', paddingVertical: 6 }}>
            <Text style={{ fontSize: 13, color: '#71717a' }}>📆 租期天数</Text>
            <Text style={{ fontSize: 13, fontWeight: '500', color: '#000' }}>{pb?.rent_days || (order.lease_term ? order.lease_term * 30 : '-')} 天</Text>
          </View>
          <View style={{ display: 'flex', justifyContent: 'space-between', paddingVertical: 6 }}>
            <Text style={{ fontSize: 13, color: '#71717a' }}>💰 日租金</Text>
            <Text style={{ fontSize: 13, fontWeight: '700', color: '#000' }}>¥{Number(pb?.final_daily_rent || pb?.base_daily_rent || order.base_daily_rate || instrument?.base_daily_rate || 0).toFixed(2)}</Text>
          </View>
          <View style={{ display: 'flex', justifyContent: 'space-between', paddingVertical: 6 }}>
            <Text style={{ fontSize: 13, color: '#71717a' }}>🔒 押金</Text>
            <Text style={{ fontSize: 13, fontWeight: '500', color: '#000' }}>¥{deposit || instrument?.deposit || 0}</Text>
          </View>
        </View>
