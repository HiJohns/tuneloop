...
export default function Detail() {
  ...
  return (
    <View className="h-screen flex flex-col bg-[#FDFBF7] antialiased">
      {/* Nav bar */}
      <View className="w-full pt-3 pb-2 px-4 flex justify-between items-center bg-[#FDFBF7]">
      ...
      <ScrollView className="w-full flex-1" scrollY scrollWithAnimation showScrollbar={false} style={{ minHeight: 0, overflowY: 'scroll' }}>
        ...
        >
          ...
          <View className="flex items-center justify-center space-x-1.5 pb-3 bg-[#FDFBF7]">
