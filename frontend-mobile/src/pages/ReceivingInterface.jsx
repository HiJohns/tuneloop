      ...
      {currentItem && (
        <View className="bg-white mx-4 mt-3 rounded-2xl shadow-sm p-4">
          ...
          <View className="flex gap-3 mb-4">
            <View onClick={() => { setHasDamage(false); setDamageDesc(''); setDamageAmount('') }}
          ...
          {hasDamage && (
            <View style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <View>
                ...
                <Input type={env.isMiniProgram ? 'digit' : 'number'} value={damageAmount} onInput={e => setDamageAmount(getInputValue(e))} placeholder="0.00" className="w-full border rounded-lg px-3 py-2 text-sm" />
              </View>
              <View>
