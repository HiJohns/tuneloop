      ...
      >
        ...
        {loading ? (
          ...
          <View className="overflow-hidden" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <View
                key={order.id}
                className="bg-white rounded-2xl shadow-sm p-4 overflow-hidden box-border" style={{ maxWidth: '100%', boxSizing: 'border-box' }}
              ...
              >
                ...
                <View className="mt-3 flex gap-2 overflow-hidden max-w-full">
                  {!isTerminal && (
                    <>
                       {showPay && (
                        <Button
