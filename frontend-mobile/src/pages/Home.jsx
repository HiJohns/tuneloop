  ...
  return (
    <View className="h-screen w-screen overflow-hidden flex flex-col relative antialiased">
      ...
      <ScrollView className="relative z-50 w-full flex-1 overflow-y-auto" scrollY scrollWithAnimation enhanced showScrollbar={false}
        ...
        <View className={`sticky top-[62px] z-[9999] py-[3px] shadow-sm border-b border-zinc-100 transition-colors duration-300 ${scrolled ? 'bg-white/70 backdrop-blur-md' : 'bg-[#FDFBF7]'}`}>
