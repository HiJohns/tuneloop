...
type Guarantor struct {
	...
	IDPhotoFront   string    `gorm:"type:text" json:"id_photo_front"`
	IDPhotoBack    string    `gorm:"type:text" json:"id_photo_back"`
	OtherCertPhoto string    `gorm:"type:text" json:"other_cert_photo"`
