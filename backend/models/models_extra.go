...
type RepairQuote struct {
	...
	MaterialFee     Cents   `gorm:"type:decimal(10,2);not null" json:"material_fee"`
	ServiceFee      Cents   `gorm:"type:decimal(10,2);not null" json:"service_fee"`
	LogisticsFee    Cents   `gorm:"type:decimal(10,2)" json:"logistics_fee"`
