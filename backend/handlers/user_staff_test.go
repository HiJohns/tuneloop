...
func TestUpdateUser_SiteIDClear(t *testing.T) {
	t.Skip("UpdateUser site clear requires IAM bind/unbind — not available in unit-test environment; see #974")
}
...
func TestUpdateUser_SiteIDChange_UnbindFails_NoDbUpdate(t *testing.T) {
	t.Skip("UpdateUser site change requires IAM bind/unbind + FK tenant reference — not available in unit-test environment; see #974")
}
